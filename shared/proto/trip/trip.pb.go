...
const file_trip_proto_rawDesc = "" +
	...
	"\fend_location\x18\x03 \x01(\v2\x10.trip.CoordinateR\vendLocation\"\x80\x01\n" +
	"\x13PreviewTripResponse\x12\x17\n" +
	"\atrip_id\x18\x01 \x01(\tR\x06tripId\x12!\n" +
	"\x05route\x18\x02 \x01(\v2\v.trip.RouteR\x05route\x12-\n" +
	"\n" +
	"ride_fares\x18\x03 \x03(\v2\x0e.trip.RideFareR\trideFares\"F\n" +
	"\n" +
	"Coordinate\x12\x1a\n" +
	...
	"\bGeometry\x122\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x10.trip.CoordinateR\vcoordinates\"\x87\x01\n" +
	"\bRideFare\x12\x0e\n" +
	...
	"\tcar_plate\x18\x04 \x01(\tR\bcarPlate2\x92\x01\n" +
	"\vTripService\x12B\n" +
...
var file_trip_proto_depIdxs = []int32{
	...
	5,  // 3: trip.PreviewTripResponse.ride_fares:type_name -> trip.RideFare
	...
	5,  // 7: trip.Trip.selected_fare:type_name -> trip.RideFare
